      ...
      var t = F(7320),
        ...
        a = function (u) {
          var D = u.authorDetails,
            ...
            c = void 0 === i ? [] : i,
            o = u.canonicalUrl,
            s = ((0, C.useRouter)(), new Date(B).toISOString()),
            l = new Date(r || B).toISOString(),
            m = (0 === c.length ? [A().socialBanner] : 'string' === typeof c ? [c] : c).map(
              function (u) {
          ...
          return (0, t.BX)(t.HY, {
            children: [
              ...
              (0, t.BX)(e.default, {
                children: [
                  B && (0, t.tZ)('meta', { property: 'article:published_time', content: s }),
                  r && (0, t.tZ)('meta', { property: 'article:modified_time', content: l }),
                  (0, t.tZ)('script', {
